...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1a362e1ab83180feb0aed998a9d47ea3,en:1a362e1ab83180feb0aed998a9d47ea3',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.adrien.pp.ua/', // 网站地址
  ...
  GREETING_WORDS:
    ...
    '沉默才是最深邃的力量, 獨行才是最堅定的航向,冷眼才是最明智的護盾,孤獨才是最崇高的自由',
